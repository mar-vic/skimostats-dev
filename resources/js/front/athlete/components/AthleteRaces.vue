        ...
        <div class="col-md-10">
          ...
          <div v-else class="py-5">
            ...
            <h2 class="font-weight-bold text-uppercase pt-0 pt-md-2 text-blue mb-4">
              season summary: {{seasonSummary.Elevation}} D+ in {{seasonSummary.RaceDays}} days with {{seasonSummary.Points}} SkiMo Stats Points
            </h2>
...
export default {
  ...
  computed: {
    ...mapState(['athleteId']),
    ...mapState('races', ['races', 'error', 'year', 'years', 'loading', 'raceDays', 'seasonSummary']),
  ...
  methods: {
    ...
    async loadRaces (year) {
      ...
      try {
        ...
        await this.$store.dispatch('races/loadSeasonSummary', {
          athleteId: this.athleteId,
          year
        })
      } catch (e) {

<template>
    <div class="container">
      ...
      <div v-if="event.id == 1257">
        <h2 class="text-uppercase font-weight-bold">
          Event live stream
        </h2>
        <iframe width="100%" height="400" src="https://www.youtube.com/embed/ay0AannDC90" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>

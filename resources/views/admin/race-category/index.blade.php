            ...
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    <div>
                        ...
                        <a href='{{ route('admin.races.edit', $race) }}'>{{ $race->name }}</a> &raquo;
                        <a href='{{ route('admin.race-types.list', $race) }}'>Race types</a> &raquo;
                        <a href='{{ route('admin.race-types.edit', $raceType) }}'>{{ $raceType->name }}</a> &raquo; Race categories
                    </div>
                    <a href='{{ route('admin.' . $slug . '.add', $raceType->getKey()) }}' class='ml-auto btn btn-sm btn-success'>+ Add</a>
                </div>
                    ...
                    <table class='table table-striped'>
                        ...
                        <tbody>
                            @foreach($entries as $entry)
                                <tr>
                                    <td><a href='{{ route('admin.race-category.edit', $entry) }}'>{{ $entry->name }}</a></td>

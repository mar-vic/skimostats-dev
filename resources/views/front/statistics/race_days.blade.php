                ...
                <div class="col col-auto pl-1 pr-1">
                    ...
                    <div class="position-relative dropdown__container no-vue">
                        ...
                        <div class="dropdown__menu dropdown__menu--right">
                            ...
                            <a href="/statistics/race-days/all-seasons" {{ $year == 'all-seasons' ? "class=fw-bold" : '' }}>All</a>

                            @foreach ($years as $yr)
                            <a {{ $year == $yr ? "class=fw-bold" : '' }} href={{ "/statistics/race-days/".$yr }}>{{ $yr }}</a>
                            @endforeach
        ...
        <div class="col-3 d-none d-md-block">
            <a :href="'/athlete/' + highlightedAthlete.slug" class="latest-results__first mb-3 profile-pic">
                ...
                <div class="latest-results__info">
                    ...
                    <div class="small mb-2" x-text="'Race days: ' + highlightedAthlete.qty"></div>
                ...
                <table class="table table-stats table--races table--races-striped">
                    <thead>
                        <tr>
                            ...
                            <th style="width:20%;text-align:right">Race days</th>
                        </tr>
                    </thead>
                    <tbody>
